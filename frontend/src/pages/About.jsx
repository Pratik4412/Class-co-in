  ...
  return (
    <div className="flex flex-col gap-14">
      <div className="about-section">
        <div className="px-5 md:px-10 lg:px-20 py-6 md:py-10 bg-[linear-gradient(180deg,rgba(24,15,11,0.75)_0%,rgba(24,15,11,0.45)_85%,rgba(24,15,11,0.75)_100%)] w-full h-full">
